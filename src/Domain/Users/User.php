...
use Carguru\VendorBundle\Contract\CommunicationInterface;
use Carguru\VendorBundle\Contract\SuperAdminInterface;
use Carguru\VendorBundle\Repository\Users\UserGroupRepository;
use Carguru\VendorBundle\Repository\Users\UserRepository;
use Carguru\VendorBundle\Traits\AdvancedUserInterfaceTrait;
...
use Carguru\VendorBundle\Validator\Constraint as UserConstraint;
...
class User implements UserInterface, SuperAdminInterface, CommunicationInterface, EquatableInterface, \Serializable, \Stringable, PasswordAuthenticatedUserInterface
{
    ...
    #[\Carguru\VendorBundle\Validator\Constraint\Password(groups: ["Password","Registration"])]
